...
//        mapManager.dispatchMap(new MapExit("RTL_THIRD", new Vector2(73, 40), player.direction));
        mapManager.dispatchMap(new MapExit("ROOM", new Vector2(5, 5), player.direction));
